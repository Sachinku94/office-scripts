...
execelfile = r'C:\Users\Primotech\Documents\pw-linkstesting\modified_excel_file.xlsx'
...
def handle_devops_status(source_url,status, destination_url):
    ...
    return'pass'    
             ...
             # If status doesn't match any condition, consider it as pass
    # elif status.startswith('Already Working'):
    #     driver.get(source_url)
    #     driver.find_element(By.XPATH,"//input[@type='password']").send_keys('pw@123!')
    #     driver.find_element(By.XPATH,"//input[@type='submit']").click()
    #     links = driver.find_elements(By.TAG_NAME, 'a')
